...
export const TeacherDeficitModal = ({
    ...
    return (
        <>
            <FadeIn show={isOpen} className="fixed inset-0 z-[300]">
                <div onClick={onClose} className="absolute inset-0 bg-slate-900/60 backdrop-blur-sm" />
            </FadeIn>
            <SlideIn show={isOpen}
                className="fixed inset-0 z-[301] flex items-center justify-center p-4"
            >
                <div className="w-[90vw] md:w-[600px] h-[80vh] bg-white rounded-[40px] shadow-2xl border border-amber-100 flex flex-col overflow-hidden">
                    {/* رأس النافذة */}
